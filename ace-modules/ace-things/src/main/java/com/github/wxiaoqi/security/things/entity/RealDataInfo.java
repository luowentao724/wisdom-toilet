 ...
 */
@Table(name = "real_data_info")
public class RealDataInfo implements Serializable {
	 ...
	 * 设置：实时数据类型
	 */
	public void setRealtimeDataType(String realtimeDataType) {
		this.realtimeDataType = realtimeDataType;
	}
	/**
	 * 获取：实时数据类型
	 */
	public String getRealtimeDataType() {
